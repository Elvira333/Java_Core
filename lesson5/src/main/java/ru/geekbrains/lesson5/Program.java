...
import static ru.geekbrains.lesson5.Tree.copyFilesToDirectory;
...
public class Program {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String sourceDirectoryPath = "lesson5";
        String targetDirectoryPath = "lesson5/backup";

        copyFilesToDirectory(sourceDirectoryPath, targetDirectoryPath);
